...
// define jQuery and $ identifiers
    ...
    "underscore": "@lodash",
    "collection/field": (function (require, exports, module) { /* wrapped by builder */
    ...
    "collection/ship": (function (require, exports, module) { /* wrapped by builder */
    ...
    "model/cell": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone');
    ...
    "model/player": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone'),
            _ = require('lodash');
    ...
    "model/ship": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone');
    ...
    "template/field": "<table>\n    <% for(var i = 0; i < size + 1; i++) { %>\n        <tr>\n            <% for(var j = 0; j < size + 1; j++) { %>\n                <% if (i === 0 && j === 0) { %>\n                    <td></td>\n                <% } else if(i === 0 && j !== 0) { %>\n                    <td class='text-center marker-top'><%= j %></td>\n                <% } else if(i !== 0 && j === 0) { %>\n                    <td class='text-center marker-left'><%= letters[i - 1] %></td>\n                <% } else { %>\n                    <td class='cell' data-row='<%= i - 1 %>' data-col='<%= j - 1 %>'>\n                        <div class='shot-marker'></div>\n                    </td>\n                <% } %>\n            <% } %>\n        </tr>\n    <% } %>\n</table>",
    "template/ship": "<div class='ship' data-length='<%= ship.get('length') %>' data-id='<%= ship.cid %>'></div>",
    "view/field": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone'),
            _ = require('lodash'),
    ...
    "view/ships": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone'),
    ...
    "view/status": (function (require, exports, module) { /* wrapped by builder */
        var Backbone = require('backbone');
...
//@ sourceMappingURL=/javascripts/main.min.map?0.11594047374092042
